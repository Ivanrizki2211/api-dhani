...
app.listen(PORT, () => {
    ...
    console.log(color("> Rest api ini dibuat oleh ``Vanz``",'white'))
    console.log(color("> Buy rest api no pasaran bisa beli di Vanz,",'white'))
    console.log(color("> Whatsapp :","red"), color("\n › no : 62838-6341-1892\n › link : https://wa.me/6283863411892",'white'))
    console.log(color("> Instagram :","red"), color("\n › name : @dhaniofficiall_\n › link : https://instagram.com",'white'))
